...
msg_if_not_subscribed = f'Подпишись на нас, чтобы не потеряться:\n' \
                        f'{str_groups}\n\n' \
                        f'А после ищи что душе угодно, это сделано для того,\n' \
                        f'чтобы мы могли функционировать и ты мог смотреть фильмы\n' \
                        f'и сериалы бесплатно, спасибо за понимание!'
